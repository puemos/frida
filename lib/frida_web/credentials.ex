defmodule FridaWeb.Credentials do
  @moduledoc "Authentication helper functions"

  alias Frida.Users.User
  ...
  def get_user(socket, session, config \\ [otp_app: :frida])

  def get_user(socket, %{"frida_auth" => signed_token}, config) do
