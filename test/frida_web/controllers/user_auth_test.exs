defmodule FridaWeb.UserAuthTest do
  use FridaWeb.ConnCase, async: true

  alias Frida.Accounts
  alias FridaWeb.UserAuth
  import Frida.AccountsFixtures

  setup %{conn: conn} do
    conn =
      conn
      |> Map.replace!(:secret_key_base, FridaWeb.Endpoint.config(:secret_key_base))
      |> init_test_session(%{})
  ...
  describe "logout_user/1" do
    ...
    test "broadcasts to the given live_socket_id", %{conn: conn} do
      ...
      FridaWeb.Endpoint.subscribe(live_socket_id)
